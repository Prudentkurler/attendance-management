...
const Header = ({
  ...
  return (
    <header className="dashboard-header sticky top-0 z-10 flex items-center justify-between bg-ds-gray p-4">
      <Button
        aria-expanded={isSidebarExpanded}
        aria-controls="dashboard-sidebar"
        className="hidden items-center justify-center bg-ds-primary text-background hover:bg-ds-primary lg:flex"
        size="sm"
      ...
      <Button
        aria-expanded={isSidebarExpanded}
        aria-controls="dashboard-sidebar"
        className="bg-ds-primary text-background hover:bg-ds-primary lg:hidden"
        size="sm"
