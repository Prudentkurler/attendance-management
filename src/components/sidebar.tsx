                      ...
                      <li
                        ...
                        className={cn("rounded capitalize text-background", {
                          "rounded text-ds-primary after:p-2":
                            (pathname === href && !isSidebarExpanded) ||
                            (matchingSubLink && !isSidebarExpanded),
                        })}
                      >
                        {isAccordion ? (
                          <AccordionItem
                          ...
                          >
                            ...
                            >
                              {/* only displays the icons has been minimized */}
                              <button
                                className={cn("ml-auto hidden", {
                                  block: !isSidebarExpanded,
                                })}
                              >
                          ...
                          <Link
                            ...
                            className={cn("py-2 text-inherit", {
                              ...
                              "text-ds-primary":
                                isSidebarExpanded && pathname === href,
                            })}
                          >
